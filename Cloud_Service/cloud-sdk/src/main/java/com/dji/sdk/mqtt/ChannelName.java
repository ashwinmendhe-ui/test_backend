...
public class ChannelName {
    ...
    // robot topics
    public static final String INBOUND_ROBOT_HEALTH = "inboundRobotHealth";

    public static final String INBOUND_ROBOT_RESPONSE = "inboundRobotResponse";

    public static final String INBOUND_ROBOT_JOB_STATE = "inboundRobotJobState";

    public static final String INBOUND_ROBOT_TELEMETRY = "inboundRobotTelemetry";
